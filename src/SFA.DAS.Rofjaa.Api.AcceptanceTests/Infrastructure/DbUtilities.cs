...
using Standard = SFA.DAS.Rofjaa.Domain.Entities.Standard;
using LarsStandard = SFA.DAS.Rofjaa.Domain.Entities.LarsStandard;
...
namespace SFA.DAS.Rofjaa.Api.AcceptanceTests.Infrastructure
{
    public static class DbUtilities
    {
        ...
        public static IEnumerable<Agency> GetFrameworks()
        {
        ...
        public static Agency GetFramework(string id)
        {
